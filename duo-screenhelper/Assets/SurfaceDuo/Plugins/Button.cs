...
public class Button : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(HEAD_INDENT, ROW_HEIGHT * 15, 200, 20), "-Window Manager (1.0.0)-", localStyle);
        ...
        localStyle.normal.textColor = new Color(0.15f, 0.51f, 0.37f);
        ...
        {
            GUI.Label(new Rect(LEFT_MARGIN, ROW_HEIGHT * 25, 400, 20), "(most dual-screen attributes have no value in editor)", localStyle);
        }
#endif
